...
module.exports.subtype = subtyper(SBError, defaultRenderer);
...
function defaultRenderer(template, details) {
    return Mustache.render(template, details || {});
}

function subtyper(ParentClass, parentRenderer) {
    return (name, template, newRenderer) => {
        const render = newRenderer || parentRenderer;
        ...
        const result = class extends ParentClass {
            constructor(details, cause) {
                ...
                if (details === topSecret) {
                    ...
                    message = render(template, details);
                }
        ...
        result.subtype = subtyper(result, render);
